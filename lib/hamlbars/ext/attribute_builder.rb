    ...
    module AttributeBuilder
      ...
      def self.included(base)
        base.instance_eval do
          ...
          # Overload build_attributes in Haml::AttributeBuilder to allow
          ...
          def build_attributes_with_handlebars_attributes_base(is_html, attr_wrapper, escape_attrs, attributes={})
            ...
            if bind = attributes.delete('bind')
              handlebars_rendered_attributes << Hamlbars::Ext::AttributeBuilder.handlebars_attributes('bind-attr', bind)
            end
